...
def cylinder():
    ...
    z_stepsize = get_integer_input("Number of mm between each z-plane: ", negative=False)
    z_min = get_integer_input("Lowest point of the cylinder: ", negative=True)
    azimuth_points = get_integer_input("Number of points in the azimuth angle:", negative=False)
    z_offset = get_integer_input("Offset in the z-axis:", negative=True)
    laser_angle = get_integer_input("The angle of the end effector to point the laser upwards by:", negative=False)
...
def half_sphere():
    ...
    azimuth_points = get_integer_input("Number of points in the azimuth plane: ", negative=False)
    elevation_points = get_integer_input("Number of points in the elevation plane: ", negative=False)
    z_min = get_integer_input("How low the half-sphere should go in the z-axis: ", negative=True)
    z_offset = get_integer_input("Offset in the z-axis:", negative=True)
...
file_name = input("Please enter your desired name for the file where the data will be saved:")
