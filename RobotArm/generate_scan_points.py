...
def generate_scan_points_cylinder(
    ...
    z = np.arange(z_offset, z_min - 1e-10, -z_stepsize)
...
def generate_points_in_square_plane(z_offset=-130, dist=1, side_len=2.5):
    ...
    """
    val = np.arange(-side_len/2, side_len/2 + 1e-10, dist)
