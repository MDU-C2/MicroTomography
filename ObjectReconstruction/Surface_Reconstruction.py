...
class surface_Reconstruction():
    ...
    def poisson_surfRecon(points,save):
        ...
        pcd.estimate_normals(search_param=o3d.geometry.KDTreeSearchParamHybrid(norm_Radius, norm_NN))
        ...
        orient_Norm_Knn = 10
        pcd.orient_normals_consistent_tangent_plane(orient_Norm_Knn) ##Very expensive time and resource wise.
        ...
        with o3d.utility.VerbosityContextManager(
            ...
            mesh, densities = o3d.geometry.TriangleMesh.create_from_point_cloud_poisson(
                pcd, depth=5,linear_fit=True) ## Depth increases the octree depth, basically giving more detail. Good data with many data points can have higher depth
