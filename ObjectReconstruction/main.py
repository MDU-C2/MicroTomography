...
step_down = 0.0005 #Step size for spline interpolation with x,y in Z direction. The smaller this value is, the more values will be added, duh. 
totalTime = time.time()
t = time.time()
...
nPoints = 50 #n*nPoints = number of new points
n = data_X.shape[1] 
t = time.time()
